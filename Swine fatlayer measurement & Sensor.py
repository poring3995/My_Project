    ...
    # Convert tensor to NumPy array
        ...
        if ret:
            ...
            if results[0].boxes.cls.numel() != 0 :
                ...
                permissions = 0o755  # This grants read, write, and execute permissions to the owner, and read/execute permissions to group and others
# Change the permissions of the directory
        ...
        # Resize the marked image for display (limit to 800 pixels)
    ...
    #def read_modbus(self):
        # Implement your Modbus read logic here
        #pass
    def read_modbus(self):
        if self.modbus_client.connect():
            try:
                ...
                if not result.isError():
                    ...
                    if 200 <= result.registers[0] <= 1000:
                        # self.delete_existing_files()
                        self.save_frames(5)
                        self.measure_count = 0
                        self.frame_count = 0
